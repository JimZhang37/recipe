...
public class JSONTool {
    ...
    public static String toJson() {
        ...
        Ingredient i1 = new Ingredient(2, "oo", "baicai");

        Ingredient i2 = new Ingredient(3, "oo9", "tudou");

        Step s1 = new Step(1, "aaa", "bbb", "url", "url2");

        Step s2 = new Step(2, "aaa", "bbb", "url", "url2");

        Step s3 = new Step(3, "aaa", "bbb", "url", "url2");
        ...
        Recipe r1 = new Recipe(1, "recipe1", iList, sList, 8, "urlabc");

        Ingredient ii1 = new Ingredient(2, "oo", "baicai");

        Ingredient ii2 = new Ingredient(3, "oo9", "tudou");

        Step ss1 = new Step(1, "aaa", "bbb", "url", "url2");

        Step ss2 = new Step(2, "aaa", "bbb", "url", "url2");

        Step ss3 = new Step(3, "aaa", "bbb", "url", "url2");

        ArrayList<Ingredient> iiList = new ArrayList<Ingredient>();
        iiList.add(ii1);
        iiList.add(ii2);

        ArrayList<Step> ssList = new ArrayList<Step>();
        ssList.add(ss1);
        ssList.add(ss2);
        ssList.add(ss3);

        Recipe r2 = new Recipe(2, "recipe2", iiList, ssList, 2, "urlabc");
...
//    }
    ...
    public static String fromJson() {
        ...
        ArrayList<Recipe> rr = gson.fromJson(s, token.getType());
